...
urlpatterns = [
    ...
    path('news-board-detail/<int:id>', views.news_board_detail, name='news-board-detail'),
    ...
    path('news-comment-list/<int:id>', views.news_comment_list, name='news-comment-list'),
]
