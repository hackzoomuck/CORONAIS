...
urlpatterns = [
    ...
    path('news-board-detail/<str:pk_id>', views.news_board_detail, name='news-board-detail'),
    ...
    path('news-comment-list/<str:pk_id>', views.news_comment_list, name='news-comment-list'),
]
